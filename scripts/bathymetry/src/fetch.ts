/**
 * Snapshot fetcher (A06b) — pull a source into the permanent `.raw/` archive.
 *
...
async function main(): Promise<void> {
  ...
  // One run row per source (A06c F2), labelled to match what the archive backfill reconstructs, so a
