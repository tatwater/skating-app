 ...
 *
 * This is a scrape of a small public-benefit organization's site, run on the founder's call (see
    ...
    `${JSON.stringify(
      {
        ...
        license:
          'NO PUBLISHED TERMS. Checked every page 2026-08-08: the site carries no license, no ' +
