#!/usr/bin/env python3
"""Turn Sentinel-1's calibration annotation into a raster that can be warped (A06e PR 2, §3.1).
...
across directions it looks like −0.03 dB, which is two opposite biases canceling and is the number most
