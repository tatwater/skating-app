...
//
// `?track=` carries the local id of a just-finished recording (Phase 08), so "Report this skate"
// lands here with the form already open and the track attached.
//
// `?activity=` carries the **server** id of an already-synced skate (A06f), which is what the You
