 ...
 * mobile. Only the colors are per-app, because they come from the design tokens.
 */
...
/**
 * Hazard colors per basemap flavor, keyed to match `WATER_PALETTE` so the map component looks both
