 ...
 *
 * This panel was text-first through Workstream 3, on the reasoning that `apps/mobile` had no charting
 * library and Phase 07-2's Recharts kit is web-and-admin-only. Workstream 4 showed that framing was
