...
> *"apply for Garmin / COROS / Polar partner programs now"* since Phase 0, and `05-accounts-and-
...
track → `gpsActivities`, resolve to lake, link to report — the B spine Phase 8 already built), one
