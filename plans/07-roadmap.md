...
*Left for later:* **water bodies have no aliases** — the corpus wants "Saranac Lake" and OSM has Upper,
Lower and Middle. Sub-areas got aliases; the same argument applies one level up. Founder call, since it
touches the body model.
