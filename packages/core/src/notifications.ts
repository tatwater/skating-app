/**
 * The notification vocabulary and the inbox's rendering model (N8 / D162).
 *
 ...
 * plan's Correction 2 for the four that didn't, and D162 for why that's now a rule rather than a
 * hope.
 */
