 ...
 * hold (Phase 02b). Single-sourced here so both the ETL loader (which tags a batch via `--state=XX`)
...
/** The Northeast lake-skating pilot states (Phase 02b): NY, VT, NH, ME, MA. */
